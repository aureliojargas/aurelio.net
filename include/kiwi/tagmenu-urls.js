...
[0, 'Importa agenda (CSV) no tocador de MP3 xingue-lingue',	'http://aurelio.net/blog/2005/11/09/contatos-do-csv-para-o-tocador-de-mp3/',	'software python musica blog'],
...
[1, 'MiGuXeiToR', 	'http://www.coisinha.com.br/miguxeitor/',	'software javascript web'],
[1, 'Engripeitor', 	'http://www.coisinha.com.br/engripeitor/',	'software javascript web'],
[1, 'Embriagueitor', 	'http://www.coisinha.com.br/embriagueitor/',	'software javascript web'],
...
[1, 'DORT / LER - Dicas para evitar lesões no computador',	'/doc/dort.html',	'doc'],
...
[0, 'RdL #04 - Vi, Vim e Venci',	'/vim/vi-vim-venci.html', 'doc vim'],
...
[0, 'RdL #49 - Pulando com o VI',	'/vim/pulando.html',	'doc vim'],
...
[1, 'Expressões Regulares - Guia de Consulta Rápida',	'/er/guia/',	'doc livro regex python php javascript sed vim'],
[1, 'Expressões Regulares Online',	'http://guia-er.sf.net',	'doc livro regex python php javascript sed vim'],
[1, 'Livro Expressões Regulares - Uma Abordagem Divertida',	'/er/livro/',	'doc livro regex python php javascript sed vim'],
[2, 'Livro Expressões Regulares - Uma Abordagem Divertida (2ª edição)',	'http://www.piazinho.com.br',	'doc livro regex python php javascript sed vim shell'],
[2, 'Livro Shell Script Profissional',	'http://www.shellscript.com.br',	'doc livro shell sed cygwin linux mac regex web'],
[0, 'Livro Dominando o SED',	'/sed/livro/',	'doc livro sed'],
[0, 'Escreva corretamente: CaracterE cUringa',	'http://aurelio.net/blog/2006/09/17/caractere-curinga/',	'doc regex blog'],
[1, 'Cartilha do Webdesigner Antenado',	'http://aurelio.net/blog/2006/06/01/cartilha-do-webdesigner-antenado/',	'doc web blog'],
[0, 'CSS: Menu fixo porém líquido',	'http://aurelio.net/blog/2006/06/30/css-menu-fixo-porem-liquido/',	'doc web blog'],
[0, 'CAPTCHA de pobre',	'http://aurelio.net/blog/2007/05/11/captcha-de-pobre/',	'doc web php blog'],
[0, 'E-book ou livro impresso, como publicar sua obra?',	'http://aurelio.net/blog/2006/05/15/e-book-ou-livro-impresso-como-publicar-sua-obra/', 'doc livro blog'],
[0, 'Como instalar o Vim 7 no Mac OS X',	'http://aurelio.net/blog/2006/09/19/como-instalar-o-vim-7-no-mac-os-x/',	'doc mac vim blog'],

// listas
[0, 'Lista Linux2macosx',	'http://br.groups.yahoo.com/group/linux2macosx',	'forum linux mac'],
...
[0, 'Lista Cygwin',	'http://br.groups.yahoo.com/group/cygwin-br',	'forum cygwin'],
...
[0, 'Carbona',	'http://aurelio.net/blog/2006/04/30/dica-de-banda-carbona/',	'banda musica blog'],
[1, 'Roda de Pogo - A Dança Punk',	'/pogo/',	'musica'],
[0, 'Blog - Música',	'http://aurelio.net/tags/#musica',	'musica blog'],
[0, 'Blog - Sonzeira do Mês',	'http://aurelio.net/tags/#sonzeira-do-mes',	'musica blog'],

// site
[0, 'Sobre o site',	'/sobre.html',	'site'],
[0, 'Mapa do site',	'/mapa.html',	'site'],
[1, 'Google AdSense - Como ganho $$$ com o site',	'/adsense/',	'site blog eu'],
...
[0, 'Processo de desnerdização',	'http://aurelio.net/blog/2005/11/30/processo-de-desnerdizacao/',	'eu blog'],
[0, 'Aurelio v2.8',	'http://aurelio.net/blog/2005/10/07/aurelio-v28/',	'eu blog'],
[0, 'Aurelio v2.9',	'http://aurelio.net/blog/2006/10/07/aurelio-v29/',	'eu blog'],
[0, 'Aurelio v3.0',	'http://aurelio.net/blog/2007/10/07/fiz-trinta/',	'eu blog'],
[0, 'Um ano sem Linux',	'http://aurelio.net/blog/2005/10/02/um-ano-sem-linux/',	'eu linux mac blog'],
[0, 'Dois anos de Mac OS X',	'http://aurelio.net/blog/2006/10/16/dois-anos-de-mac-os-x/',	'eu linux mac blog'],
[0, 'Free as in BIRD',	'http://aurelio.net/blog/2005/09/23/free-as-in-bird/',	'eu linux mac blog'],
...
// foto
[0, 'Aurelio Freak Show',	'/foto/tosco/',	'foto eu'],
...
[0, 'Jacaré do Parque Barigüi',	'http://aurelio.net/blog/2004/09/05/jacare-do-parque-barigui/',	'foto blog'],
...
[0, 'Farol de Santa Marta - SC',	'http://aurelio.net/blog/2006/09/13/farol-de-santa-marta/',	'viagem foto blog'],
...
[0, 'Não fazem mais jogos como antigamente',	'http://aurelio.net/blog/2005/12/04/nao-fazem-mais-jogos-como-antigamente/',	'game blog'],
[0, '* Blog dos meus softwares (em inglês)',	'http://aureliosoft.wordpress.com',	'applescript mac software blog'],
[0, 'Sintaxe txt2tags',	'http://txt2tags.sourceforge.net/tools/txt2tags.vim',	'vim'],
[0, 'Desenvolvedores brasileiros no Mac OS X',	'http://aurelio.net/blog/2006/08/08/desenvolvedores-brasileiros-no-mac-os-x/',	'mac blog'],
[1, '* Portal Carveboard',	'/carve/',	'foto video esporte'],
[0, 'Campeonato de Carveboard',	'http://aurelio.net/blog/2006/08/03/relato-fotos-e-videos-do-campeonato-de-carveboard/',	'foto video esporte blog']
];
